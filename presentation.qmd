...
7.  Define data splits (training vs. testing - often 80%/20% split)
8.  Fit (train) model to [training]{.underline} data
9.  Evaluate (validate) the model with [testing]{.underline} data (need to evaluate with testing data because ML learns the training data)
...
-   Assignment part 2: apply to predictingforest carbon
