...
-   Partial Credit: Provides general (rather than specific) model or engine OR does not provide both a model and engine
...
-   Partial Credit: Answer does not provide enough specific details to understand the method OR Answer is a rephrasing of help from the package
...
-   Partial Credit: Not does correctly identify whether the model requires data pre-processing OR includes incorrect steps
...
-   Partial Credit: Incorrect list of hyperparameters for the model in Question 11
...
-   Partial Credit: Code does not correctly split into folds OR in correctly states that hyperparameter tuning is not required
...
-   Partial Credit: Code does not correctly define model OR code does not use tidymodel functions
...
-   Partial Credit: Code does not correctly tune the hyperparameters OR incorrectly states that model does not require hyperparameter tuning
...
-   Partial Credit: Code does not correctly update model with tuned parameters  OR incorrectly states that model does not require hyperparameter tuning
...
-   Partial Credit: Code does not predicts new data from trained model using tidymodel functions OR no table is displayed OR code does not use tidymodel functions
...
-   Partial Credit: CSV file uploaded to Canvas but with incorrect columns

-   No Credit: No CSV uploaded to Canvas
