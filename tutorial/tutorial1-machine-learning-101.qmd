...
1) `assignment/assignment-part-1.qmd` challenges you to translate the linear regression that you did in the lake ice module following the tidymodel machine learning format presented in this Rmd

2) `assignment/assignment-part-2.qmd` challenges you to develop your own machine learning model to predict the carbon stock data from the forest carbon module.
